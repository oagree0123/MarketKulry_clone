...
const Footer = (props) => {
  return (
    <FooterContainer>
      <InnerFooter>
        <InnerLeft>
          <Text is_size="20px" is_margin="0px 0px 22px 0px" is_bold>
            고객행복센터
          </Text>
          <LeftDiv>
            ...
            <div>
              <Text is_size="14px" is_color="#333333">
                365고객센터
              </Text>
              <Text is_size="14px" is_color="grey">
                오전7시 - 오후7시
              </Text>
            </div>
          </LeftDiv>
        ...
        <InnerRight>
          ...
          <div>
            ...
            <Text is_size="12px" is_color="#999999">
              입점문의&nbsp;:&nbsp;
              <span style={{ color: "#5f0080" }}>입점문의하기</span> |
              마케팅제휴:{" "}
              <span style={{ color: "#5f0080" }}> business@kurlycorp.com </span>
            </Text>
            <Text is_size="12px" is_color="#999999">
              채용문의&nbsp;:&nbsp;
              <span style={{ color: "#5f0080" }}> recruit@kurlycorp.com</span>
            </Text>
            <Text is_size="12px" is_color="#999999">
              팩스&nbsp;:&nbsp;070 - 7500 - 6098 | 이메일 :{" "}
              <span style={{ color: "#5f0080" }}> help@kurlycorp.com</span>
            </Text>
            <Text is_size="12px" is_color="#999999">
              {" "}
              대량주문 문의 &nbsp;:&nbsp;
          ...
          <ButtonWrap>
            <a href="https://fatchoi.tistory.com/manage/posts">
              <Image
